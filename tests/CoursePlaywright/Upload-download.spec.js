const ExcelJs = require('D:/2026 - Study/Playwright/Playwright-E2E/ExcelJSUtil/readandupdate_excelDemo.js'); //exceljs');
...
test('Upload download excel validation', async ({ page }) => {
  ...
  const filePath = '../Playwright-E2E/ExcelJSUtil/exceldownloadTest.xlsx'; // or await dl.path()
